...
class HttpChannel extends Channel {
  constructor(application, req, res, headers) {
...
const createChannel = (application, req, res, headers) =>
  new HttpChannel(application, req, res, headers);
