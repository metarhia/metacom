...
Client.prototype.selectApi = function(appName, apiName, apiVersion, callback) {
  this.rpcCall(null, null, 'selectApi', appName, apiName, (error, methods) => {
    const api = {};
...
Client.prototype.rpcCall = function(appName, apiName, method, ...args) {
  if (this.active) {
