...
const ws = require('ws');
const { ServerTransport, HEADERS } = require('./transport.js');
...
class Server {
  ...
  init() {
    ...
    this.httpServer.on('request', async (req, res) => {
      const transport = new ServerHttpTransport(this, req, res);
    ...
    this.wsServer.on('connection', (connection, req) => {
      const transport = new ServerWsTransport(this, req, connection);
      const client = new Client(transport);
