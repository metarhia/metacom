...
const metacomIIFE = (function (exports) {
if (typeof metautilIIFE === 'undefined') {
  throw new Error('Dependency "metautil" is not available. Ensure metautilIIFE is loaded either in service workervia importScripts("metautil.iife.js")or in main thread via <script src="metautil.iife.js"></script>before this module.');
}
const { Emitter } = metautilIIFE;
